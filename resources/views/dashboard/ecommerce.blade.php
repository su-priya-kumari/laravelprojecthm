                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info margin-0">                                                
                                        ...
                                        <li><img src="{{url('/')}}/admin_assets/img/xs/avatar6.jpg" title="Avatar" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>$ 356</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info margin-0">                                                
                                        ...
                                        <li><img src="{{url('/')}}/admin_assets/img/xs/avatar9.jpg" title="Avatar" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>$ 542</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info margin-0">                                                
                                        <li><img src="{{url('/')}}/admin_assets/img/xs/avatar3.jpg" title="Avatar" alt="Avatar"></li>
