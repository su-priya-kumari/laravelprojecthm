                ...
                <ul class="right_chat list-unstyled mb-0">
                    <li class="offline">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{url('/')}}/admin_assets/img/xs/avatar2.jpg" alt="">
                    ...
                    <li class="online">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{url('/')}}/admin_assets/img/xs/avatar3.jpg" alt="">
                                <div class="media-body">
                    ...
                    <li class="online">
                        <a href="javascript:void(0);">
                            <div class="media">
                                <img class="media-object " src="{{url('/')}}/admin_assets/img/xs/avatar4.jpg" alt="">
                                <div class="media-body">
                ...
                <div class="timeline-item blue" date-is="19-04-2018 - Yesterday">
                    ...
                    <div class="msg">
                        ...
                        <div class="timeline_img m-b-20">
                            <img class="w-25" src="{{url('/')}}/admin_assets/img/blog/blog-page-4.jpg" alt="Awesome Image">
                            <img class="w-25" src="{{url('/')}}/admin_assets/img/blog/blog-page-2.jpg" alt="Awesome Image">
                        </div>
                        <a href="javascript:void(0);" class="m-r-20"><i class="icon-heart"></i> Like</a>
