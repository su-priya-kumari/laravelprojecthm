...
<div class="row clearfix">
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card appliances-grp ng-star-inserted">
            <div class="body clearfix">
                <div class="icon"><img alt="" src="../admin_assets/img/air-conditioner.png"></div>
                <div class="content">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card appliances-grp ng-star-inserted">
            <div class="body clearfix">
                <div class="icon"><img alt="" src="../admin_assets/img/fridge.png"></div>
                <div class="content">
    ...
    <div class="col-lg-4 col-md-4 col-sm-12">
        <div class="card appliances-grp ng-star-inserted">
            <div class="body clearfix">
                <div class="icon"><img alt="" src="../admin_assets/img/washing-machine.png"></div>
                <div class="content">
