...
<div class="row clearfix">
    <div class="col-lg-3 col-md-6">
        <div class="card top_counter currency_state">
            <div class="body">
                <div class="icon"><img src="../admin_assets/img/coin/BTC.svg" width="35" /></div>
                <div class="content">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card top_counter currency_state">
            <div class="body">
                    <div class="icon"><img src="../admin_assets/img/coin/ETH.svg" width="35" /></div>
                <div class="content">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card top_counter currency_state">
            <div class="body">
                    <div class="icon"><img src="../admin_assets/img/coin/XRP.svg" width="35" /></div>
                <div class="content">
    ...
    <div class="col-lg-3 col-md-12">
        <div class="card top_counter currency_state">
            <div class="body">
                    <div class="icon"><img src="../admin_assets/img/coin/neo.svg" width="35" /></div>
                <div class="content">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card top_counter currency_state">
            <div class="body">
                <div class="icon"><img src="../admin_assets/img/coin/qtum.svg" width="35" /></div>
                <div class="content">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card top_counter currency_state">
            <div class="body">
                    <div class="icon"><img src="../admin_assets/img/coin/stellar.svg" width="35" /></div>
                <div class="content">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card top_counter currency_state">
            <div class="body">
                    <div class="icon"><img src="../admin_assets/img/coin/ETC.svg" width="35" /></div>
                <div class="content">
                ...
                <div class="table-responsive">
                    <table class="table table-hover m-b-0">
                        <tbody>
                            <tr>
                                <td>
                                    <img src="../admin_assets/img/coin/BTC.svg"  width="35" />
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <img src="../admin_assets/img/coin/neo.svg"  width="35" />
                                </td>
                                <td>
                                    <small>Neo NEO</small>
                            ...
                            <tr>
                                <td>
                                    <img src="../admin_assets/img/coin/DASH.svg"  width="35" />
                                </td>
                                <td>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info margin-0">                                                
                                        <li><img src="../admin_assets/img/xs/avatar1.jpg" title="Avatar" alt="Avatar"></li>
                                        <li><img src="../admin_assets/img/xs/avatar6.jpg" title="Avatar" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>$ 356</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info margin-0">                                                
                                        <li><img src="../admin_assets/img/xs/avatar1.jpg" title="Avatar" alt="Avatar"></li>                                                
                                        <li><img src="../admin_assets/img/xs/avatar5.jpg" title="Avatar" alt="Avatar"></li>
                                        <li><img src="../admin_assets/img/xs/avatar9.jpg" title="Avatar" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>$ 542</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info margin-0">                                                
                                        <li><img src="../admin_assets/img/xs/avatar3.jpg" title="Avatar" alt="Avatar"></li>
                                        <li><img src="../admin_assets/img/xs/avatar2.jpg" title="Avatar" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>$ 542</td>
                            </tr>
