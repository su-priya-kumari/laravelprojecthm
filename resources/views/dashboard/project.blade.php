...
<div class="row clearfix">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="card top_counter">
            <div class="body">
                <div class="icon">
                    <img src="{{url('/')}}/admin_assets/img/xs/avatar2.jpg" class="rounded-circle" alt="">
                </div>
            ...
            <div class="body">
                <div class="icon">
                    <img src="{{url('/')}}/admin_assets/img/xs/avatar5.jpg" class="rounded-circle" alt="">
                </div>
                <div class="content m-t-5">
            ...
            <div class="body">
                <div class="icon">
                    <img src="{{url('/')}}/admin_assets/img/xs/avatar3.jpg" class="rounded-circle" alt="">
                </div>
                <div class="content m-t-5">
            ...
            <div class="body">
                <div class="icon">
                    <img src="{{url('/')}}/admin_assets/img/xs/avatar4.jpg" class="rounded-circle" alt="">
                </div>
                <div class="content m-t-5">
                    <div>Sales Lead</div>
                    <h6>Gary Camara</h6>
                    ...
                    <ol class="dd-list">
                        <li class="dd-item" data-id="1">
                            ...
                            <div class="dd-content top_counter">
                                <div class="icon">
                                    <img src="{{url('/')}}/admin_assets/img/xs/avatar1.jpg" class="rounded-circle" alt="">
                                </div>
                                <div class="content m-t-5">
                                    <div>UI UX Desiger</div>
                                    <h6>Tim Hank</h6>
                                ...
                                <li class="dd-item" data-id="1">
                                    ...
                                    <div class="dd-content">
                                        ...
                                        <ul class="list-unstyled team-info m-t-20 m-b-20">
                                            ...
                                            <li><img src="{{url('/')}}/admin_assets/img/xs/avatar1.jpg" title="Avatar" alt="Avatar"></li>
                                            <li><img src="{{url('/')}}/admin_assets/img/xs/avatar2.jpg" title="Avatar" alt="Avatar"></li>
                                            <li><img src="{{url('/')}}/admin_assets/img/xs/avatar5.jpg" title="Avatar" alt="Avatar"></li>
                                        </ul>
                        ...
                        <li class="dd-item" data-id="1">
                            ...
                            <div class="dd-content top_counter">
                                <div class="icon">
                                    <img src="{{url('/')}}/admin_assets/img/xs/avatar10.jpg" class="rounded-circle" alt="">
                                </div>
                                <div class="content m-t-5">
                                ...
                                <li class="dd-item" data-id="1">
                                    ...
                                    <div class="dd-content">
                                        <ul class="list-unstyled team-info">
                                            <li><img src="{{url('/')}}/admin_assets/img/xs/avatar5.jpg" alt="Avatar"></li>
                                            <li><img src="{{url('/')}}/admin_assets/img/xs/avatar6.jpg" alt="Avatar"></li>
                                        </ul>
                                    </div>
                                </li>
                                <li class="dd-item" data-id="1">
                                    ...
                                    <div class="dd-content">
                                        <ul class="list-unstyled team-info">
                                            <li><img src="{{url('/')}}/admin_assets/img/xs/avatar7.jpg" alt="Avatar"></li>
                                            <li><img src="{{url('/')}}/admin_assets/img/xs/avatar8.jpg" alt="Avatar"></li>
                                            <li><img src="{{url('/')}}/admin_assets/img/xs/avatar9.jpg" alt="Avatar"></li>
                                            <li><img src="{{url('/')}}/admin_assets/img/xs/avatar10.jpg" alt="Avatar"></li>
                                        </ul>
                                    </div>
                                </li>
                            </ol>
                    ...
                    <table class="table m-b-0 table-hover">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info">
                                        <li><img src="{{url('/')}}/admin_assets/img/xs/avatar1.jpg" alt="Avatar"></li>
                                        <li><img src="{{url('/')}}/admin_assets/img/xs/avatar2.jpg" alt="Avatar"></li>
                                        <li><img src="{{url('/')}}/admin_assets/img/xs/avatar3.jpg" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <ul class="list-unstyled team-info">
                                        <li><img src="{{url('/')}}/admin_assets/img/xs/avatar4.jpg" alt="Avatar"></li>                                                
                                        <li><img src="{{url('/')}}/admin_assets/img/xs/avatar6.jpg" alt="Avatar"></li>
                                    </ul>
                                </td>
                                <td>
